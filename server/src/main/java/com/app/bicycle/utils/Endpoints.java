...
public class Endpoints {
    ...
    //Stations
    public final String ALL_STATIONS = "app/stations/getAllStations"; // идва useless ама знае ли се
    ...
    //Bicycles
    public final String ALL_BICYCLES = "app/bicycles/getAllBicycles"; //май пак useless
    ...
    //Users
    public final String REGISTER_USER = "app/user/registerUser"; //не работи
    public final String RENT_BICYCLE = "app/user/rent"; //ще бъде вероятно преместено към bicycle контролера
